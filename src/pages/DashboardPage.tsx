...
export default function DashboardPage() {
  ...
  const stats = useMemo(() => [
    ...
    { label: 'Capacidade CR', value: totalCR, icon: Database, color: 'text-blue-600', bg: 'bg-blue-50', description: 'Vagas em reserva' },
    { label: 'Pessoas Convocadas', value: totalConvocados, icon: Users, color: 'text-purple-600', bg: 'bg-purple-50', description: 'Candidatos convocados' },
    { label: 'Pessoas Vencidas', value: totalVencidos, icon: AlertCircle, color: 'text-red-600', bg: 'bg-red-50', description: 'Candidatos em bancos expirados' },
    { label: 'Capacidade Prorrogada', value: totalProrrogados, icon: Clock, color: 'text-blue-600', bg: 'bg-blue-50', description: 'Vagas em bancos prorrogados' },
    { label: 'Capacidade Vigente', value: totalComBancoValido, icon: ShieldCheck, color: 'text-emerald-600', bg: 'bg-emerald-50', description: 'Reserva + Prorrogados' },
